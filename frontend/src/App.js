...
function App() {
  ...
  return (
    <>
      ...
      <div className="App min-h-screen bg-gradient-to-br from-emerald-50/30 via-white to-teal-50/30 text-gray-900 relative overflow-hidden">
        {/* Main Application */}
        <div className="relative flex flex-col h-screen">
          <Header />
          <div className="flex flex-1 overflow-hidden">
            <Sidebar activeView={activeView} onNavigate={setActiveView} />
            <main className="flex-1 overflow-auto bg-gradient-to-br from-white/50 to-emerald-50/20">
