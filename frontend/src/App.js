              ...
              {activeView === 'workflow' && (
                <div className="flex items-center justify-center h-full">
                  <div className="text-center space-y-3">
                    <i className="fa-solid fa-diagram-project text-6xl text-primary animate-float" />
                    <h3 className="text-2xl font-display font-bold">Workflow</h3>
              ...
              {activeView === 'settings' && (
                <div className="flex items-center justify-center h-full">
                  <div className="text-center space-y-3">
                    ...
                    <h3 className="text-2xl font-display font-bold">Cài đặt</h3>
                    <p className="text-muted-foreground">Coming soon...</p>
                  </div>
                </div>
              )}
