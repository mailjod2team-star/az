      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed right-0 top-16 bottom-0 w-96 bg-card border-l border-border shadow-2xl z-50 flex flex-col"
          >
            {/* Header */}
            <div className="p-6 border-b border-border flex items-center justify-between">
              ...
              >
                <i className="fa-solid fa-xmark text-xl text-muted-foreground" />
              </motion.button>
            </div>
            ...
            <div className="px-6 py-3 border-b border-border flex items-center gap-2">
              ...
              <motion.button
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                className="text-xs px-3 py-1.5 bg-muted text-foreground rounded-md hover:bg-muted/80 transition-colors"
              >
                Xóa tất cả
              </motion.button>
            </div>
                ...
                >
                  <div className="flex gap-3">
                    ...
                    <div className={`mt-1 ${getTypeColor(notification.type)}`}>
                      <i className={`fa-solid ${notification.icon} text-lg`} />
                    </div>
