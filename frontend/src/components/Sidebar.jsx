...
export const Sidebar = ({ activeView, onNavigate }) => {
  const menuItems = [
    ...
    { id: 'services', icon: 'fa-scissors', label: 'Dịch vụ', color: 'teal' },
    ...
    { id: 'reports', icon: 'fa-file-chart-line', label: 'Báo cáo', color: 'violet' },
    { id: 'settings', icon: 'fa-cog', label: 'Cài đặt', color: 'gray' },
  ];

  return (
    <motion.div
      className="w-52 bg-gradient-to-br from-emerald-50 via-white to-teal-50 backdrop-blur-sm border-r border-gray-200 h-screen flex flex-col shadow-sm"
      initial={{ x: -300 }}
      animate={{ x: 0 }}
    ...
    >
      ...
      <div className="p-3 border-b border-gray-200 bg-white/50">
        <h3 className="text-xs font-bold text-gray-500 uppercase tracking-wider">Menu chính</h3>
      </div>
      ...
      <div className="flex-1 overflow-y-auto min-h-0 custom-scrollbar">
        <nav className="p-2 space-y-0.5">
          ...
          <div className="pt-3 pb-2 px-2">
            <p className="text-xs font-semibold text-gray-400 uppercase tracking-wide">Sản phẩm</p>
          </div>
