...
export const Header = () => {
  ...
  return (
    <>
      <motion.header
        className="h-16 bg-gray-100 border-b border-gray-200 flex items-center justify-between px-6 shadow-sm"
        initial={{ y: -100 }}
        animate={{ y: 0 }}
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
          >
            <i className="fa-brands fa-telegram text-xl text-gray-700" />
          </motion.button>
