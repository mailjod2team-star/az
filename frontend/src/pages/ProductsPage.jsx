          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2">
            {filteredProducts.map((product) => (
              ...
              >
                ...
                {/* Card Body - Info and Image Side by Side */}
                <div className="p-2">
          ...
          <div className="bg-white rounded border border-gray-200 overflow-hidden">
            <table className="w-full">
              <thead className="bg-gray-50 border-b border-gray-200">
                <tr>
                  <th className="px-3 py-2 text-left text-xs font-semibold text-gray-700">Ảnh</th>
                    ...
                    <td className="px-3 py-2">
                      {product.image ? (
                        ...
                        <div className="w-12 h-12 bg-gray-100 rounded border border-gray-200 flex items-center justify-center">
                          <i className="fa-solid fa-image text-gray-400 text-lg" />
                        </div>
                      )}
                    </td>
                    <td className="px-3 py-2">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      {imagePreview ? (
                        ...
                        <label className="flex flex-col items-center justify-center w-full h-48 border-2 border-gray-300 border-dashed rounded cursor-pointer hover:bg-gray-50 transition-colors">
